...
def calculate_demographic_data(print_data=True):
    ...
    country_rich_percentage = (df_rich['native-country'].value_counts() / df['native-country'].value_counts()) * 100
    ...
    df_IN_rich = df[(df['native-country'] == 'India') & (df['salary'] == '>50K')]
    top_IN_occupation = df_IN_rich['occupation'].value_counts().idxmax()
